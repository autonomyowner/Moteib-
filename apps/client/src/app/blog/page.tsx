        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Discover transformative ideas and practical wisdom to elevate your leadership journey
            </p>
          </div>
        </div>
      </div>
        ...
        {articles.length === 0 ? (
          <div className="text-center py-16">
            <div className="inline-block p-10 rounded-3xl bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 shadow-lg">
              ...
              <p className="text-[#1A5345] text-xl font-semibold">New articles coming soon!</p>
              <p className="text-slate-600 mt-2">Check back for fresh leadership insights</p>
            </div>
          </div>
        ) : (
                  ...
                  <div className="p-8 h-full flex flex-col">
                    ...
                    <div className="mb-4">
                      <time dateTime={article.entry.publishedDate || undefined} className="inline-block px-4 py-1.5 bg-amber-50 text-amber-700 text-sm font-semibold rounded-full border border-amber-200">
                        {new Date(article.entry.publishedDate || Date.now()).toLocaleDateString('en-US', {
                          year: 'numeric',
                          month: 'short',
                          day: 'numeric',
                        })}
